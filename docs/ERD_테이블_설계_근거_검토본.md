...
> 문서 성격: **검토용 비권위 초안**
>
> 현재 요구사항정의서·확정 테이블정의서·ERDCloud 스키마에 반영된 현행 설계와 그 근거를 설명하는 보조 문서다. 구현 기준은 테이블정의서와 ERDCloud 스키마다.
...
| --- | --- | --- | --- |
| DOM-01 회원 | 로그인, 온보딩, 취향, 알림 | FR-MEM-01~04, FR-NOT-01~03 | 회원, 세션, 현재 취향, 미읽은 알림, 알림 아웃박스 |
